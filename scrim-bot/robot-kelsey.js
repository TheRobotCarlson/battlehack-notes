                    ...
                    for(var i=0;i<enemy_check.length;i++){
                        ...
                        if(robotMap[my_coord[0] + temp[0]][my_coord[1] + temp[1]] > 0){
                            ...
                            if(this.getRobot(robot_id).team != this.me.team){
                                ...
                                enemy_robot = this.enemyBots.indexOf(robot_id);
                            }
                        }
                        
                    }                     
                    if(signal >> 2 == enemy_robot && enemy_robot != null){
                        var moved = false;
                        var choice = null;
...
//ADDED CODE
    ...
    buildUnitChecker(this_planet){
        var cur_x = this_planet.r;
        var cur_y = this_planet.c;
        var robotMap = this_planet.getVisibleRobotMap();
        var fullmap = this_planet.map;
